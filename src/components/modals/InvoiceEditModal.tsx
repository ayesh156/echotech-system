...
import { Plus, Trash2, Search, FileText, Package } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full mt-1 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer ${
                  theme === 'dark'
                    ? 'border-slate-700 bg-slate-800/50 text-white'
                    : 'border-slate-300 bg-slate-50 text-slate-900'
                }`}
