...
// Cash Account Types - Where money is stored
export type CashAccountType = 'drawer' | 'cash_in_hand' | 'business';
...
export const mockCashTransactions: CashTransaction[] = [
  ...
  },
  {
    ...
    transferToAccountId: 'acc-business',
  ...
  {
    id: 'txn-026',
    transactionNumber: 'TXN-2026-0026',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 6500,
    name: 'AC Service',
    description: 'Servicing of 2 shop AC units',
    category: 'Repairs',
  ...
  {
    id: 'txn-027',
    transactionNumber: 'TXN-2026-0027',
    type: 'expense',
    accountId: 'acc-hand',
    accountType: 'cash_in_hand',
    amount: 2800,
    name: 'Tea & Sugar Stock',
    description: 'Monthly pantry items purchase',
    category: 'Refreshments',
    balanceBefore: 132300,
    balanceAfter: 129500,
    transactionDate: '2026-01-02T16:45:00Z',
    createdAt: '2026-01-02T16:45:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-028',
    transactionNumber: 'TXN-2026-0028',
    type: 'income',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 85000,
    name: 'Software License Sale',
    description: '10x Microsoft Office Home & Business',
    category: 'Sales',
    balanceBefore: 427000,
    balanceAfter: 512000,
  ...
  {
    id: 'txn-029',
    transactionNumber: 'TXN-2026-0029',
    type: 'expense',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 800,
    name: 'Furniture Repair',
    description: 'Fixing customer chair leg',
    category: 'Repairs',
    balanceBefore: 144350,
    balanceAfter: 143550,
    transactionDate: '2025-12-31T15:00:00Z',
    createdAt: '2025-12-31T15:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-030',
    transactionNumber: 'TXN-2026-0030',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 3500,
    name: 'CCTV Maintenance',
    description: 'Replacing connector on Camera 3',
    category: 'Repairs',
    balanceBefore: 512000,
    balanceAfter: 508500,
    transactionDate: '2025-12-30T14:20:00Z',
    createdAt: '2025-12-30T14:20:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-031',
    transactionNumber: 'TXN-2026-0031',
    type: 'expense',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 15000,
    name: 'Used PC Purchase',
    description: 'Core i3 Desktop for parts',
    category: 'Other',
    balanceBefore: 143550,
    balanceAfter: 128550,
    transactionDate: '2025-12-29T11:30:00Z',
    createdAt: '2025-12-29T11:30:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-032',
    transactionNumber: 'TXN-2026-0032',
    type: 'income',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 5000,
    name: 'Consulting Fee',
    description: 'Network setup advice for small office',
    category: 'Services',
    balanceBefore: 508500,
    balanceAfter: 513500,
  ...
  {
    id: 'txn-033',
    transactionNumber: 'TXN-2026-0033',
    type: 'transfer',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 100000,
    name: 'Deposit to Bank',
    description: 'Weekly cash deposit to bank account',
    transferToAccountId: 'acc-business',
    transferToAccountType: 'business',
    balanceBefore: 228550,
    balanceAfter: 128550,
    transactionDate: '2025-12-27T15:30:00Z',
    createdAt: '2025-12-27T15:30:00Z',
  },
  {
    id: 'txn-034',
    transactionNumber: 'TXN-2026-0034',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 32500,
    name: 'Laptop Sales',
    description: '3x HP Pavilion laptops sold',
    category: 'Sales',
    balanceBefore: 128550,
    balanceAfter: 161050,
    transactionDate: '2025-12-26T14:15:00Z',
    createdAt: '2025-12-26T14:15:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-035',
    transactionNumber: 'TXN-2026-0035',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 12000,
    name: 'Spare Parts Inventory',
    description: 'Stocking up RAM, SSDs and hard drives',
    category: 'Other',
    balanceBefore: 513500,
    balanceAfter: 501500,
    transactionDate: '2025-12-25T11:00:00Z',
    createdAt: '2025-12-25T11:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-036',
    transactionNumber: 'TXN-2026-0036',
    type: 'expense',
    accountId: 'acc-hand',
    accountType: 'cash_in_hand',
    amount: 2250,
    name: 'Technician Transport',
    description: 'Fuel for site visits this week',
    category: 'Transport',
    balanceBefore: 132300,
    balanceAfter: 130050,
    transactionDate: '2025-12-24T16:30:00Z',
    createdAt: '2025-12-24T16:30:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-037',
    transactionNumber: 'TXN-2026-0037',
    type: 'income',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 75000,
    name: 'Bulk Desktop Order',
    description: '5x Dell Optiplex desktops with monitors',
    category: 'Sales',
    balanceBefore: 501500,
    balanceAfter: 576500,
    transactionDate: '2025-12-23T10:30:00Z',
    createdAt: '2025-12-23T10:30:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-038',
    transactionNumber: 'TXN-2026-0038',
    type: 'expense',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 6500,
    name: 'Monthly Insurance',
    description: 'Shop and inventory insurance premium',
    category: 'Supplies',
    balanceBefore: 161050,
    balanceAfter: 154550,
    transactionDate: '2025-12-22T09:00:00Z',
    createdAt: '2025-12-22T09:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-039',
    transactionNumber: 'TXN-2026-0039',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 5600,
    name: 'Warranty Claims',
    description: 'Extended warranty sales this week',
    category: 'Sales',
    balanceBefore: 154550,
    balanceAfter: 160150,
    transactionDate: '2025-12-21T13:45:00Z',
    createdAt: '2025-12-21T13:45:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-040',
    transactionNumber: 'TXN-2026-0040',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 3800,
    name: 'Google Ads Campaign',
    description: 'Digital marketing campaign for month',
    category: 'Marketing',
    balanceBefore: 576500,
    balanceAfter: 572700,
    transactionDate: '2025-12-20T14:00:00Z',
  ...
  },
  {
    ...
    accountType: 'cash_in_hand',
    amount: 30000,
    name: 'Transfer to Drawer',
    description: 'Moving cash for counter operations',
    transferToAccountId: 'acc-drawer',
    transferToAccountType: 'drawer',
    balanceBefore: 130050,
    balanceAfter: 100050,
    transactionDate: '2025-12-19T08:00:00Z',
  ...
  },
  {
    ...
    accountType: 'drawer',
    amount: 1800,
    name: 'Anti-virus Licenses',
    description: 'Monthly antivirus software subscriptions',
    category: 'Supplies',
    balanceBefore: 190150,
    balanceAfter: 188350,
  ...
  {
    id: 'txn-043',
    transactionNumber: 'TXN-2026-0043',
    type: 'income',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 42000,
    name: 'Server Setup Contract',
    description: 'Small business server setup and config',
    category: 'Services',
    balanceBefore: 572700,
    balanceAfter: 614700,
    transactionDate: '2025-12-17T15:00:00Z',
    createdAt: '2025-12-17T15:00:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-044',
    transactionNumber: 'TXN-2026-0044',
    type: 'expense',
    accountId: 'acc-hand',
    accountType: 'cash_in_hand',
    amount: 4500,
    name: 'Lunch Event Sponsorship',
    description: 'Community event sponsorship',
    category: 'Other',
    balanceBefore: 100050,
    balanceAfter: 95550,
    transactionDate: '2025-12-16T12:00:00Z',
    createdAt: '2025-12-16T12:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-045',
    transactionNumber: 'TXN-2026-0045',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 8900,
    name: 'Printer Ink & Cartridges',
    description: 'Bulk sale of printing supplies',
    category: 'Sales',
    balanceBefore: 188350,
    balanceAfter: 197250,
    transactionDate: '2025-12-15T11:20:00Z',
    createdAt: '2025-12-15T11:20:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-046',
    transactionNumber: 'TXN-2026-0046',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 7200,
    name: 'Generator Maintenance',
    description: 'Servicing backup generator system',
    category: 'Repairs',
    balanceBefore: 614700,
    balanceAfter: 607500,
    transactionDate: '2025-12-14T10:00:00Z',
    createdAt: '2025-12-14T10:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-047',
    transactionNumber: 'TXN-2026-0047',
    type: 'expense',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 950,
    name: 'Parking Fees',
    description: 'Monthly shop parking payments',
    category: 'Transport',
    balanceBefore: 197250,
    balanceAfter: 196300,
    transactionDate: '2025-12-13T09:15:00Z',
    createdAt: '2025-12-13T09:15:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-048',
    transactionNumber: 'TXN-2026-0048',
    type: 'income',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 21500,
    name: 'Corporate Consultation',
    description: 'IT consultation for large company',
    category: 'Services',
    balanceBefore: 607500,
    balanceAfter: 629000,
    transactionDate: '2025-12-12T14:30:00Z',
    createdAt: '2025-12-12T14:30:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-049',
    transactionNumber: 'TXN-2026-0049',
    type: 'expense',
    accountId: 'acc-hand',
    accountType: 'cash_in_hand',
    amount: 3100,
    name: 'Staff Uniforms',
    description: 'New shop uniforms for team',
    category: 'Supplies',
    balanceBefore: 95550,
    balanceAfter: 92450,
    transactionDate: '2025-12-11T15:30:00Z',
    createdAt: '2025-12-11T15:30:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-050',
    transactionNumber: 'TXN-2026-0050',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 18750,
    name: 'Used Device Trade-ins',
    description: '4x trade-in devices for refurbishment',
    category: 'Sales',
    balanceBefore: 196300,
    balanceAfter: 215050,
    transactionDate: '2025-12-10T13:00:00Z',
    createdAt: '2025-12-10T13:00:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-051',
    transactionNumber: 'TXN-2026-0051',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 4400,
    name: 'Employee Bonus',
    description: 'Year-end bonus for performance',
    category: 'Salaries',
    balanceBefore: 629000,
    balanceAfter: 624600,
    transactionDate: '2025-12-09T16:00:00Z',
    createdAt: '2025-12-09T16:00:00Z',
    referenceType: 'salary',
  },
  {
    id: 'txn-052',
    transactionNumber: 'TXN-2026-0052',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 11200,
    name: 'Monthly Service Contracts',
    description: 'Recurring maintenance contracts revenue',
    category: 'Services',
    balanceBefore: 215050,
    balanceAfter: 226250,
    transactionDate: '2025-12-08T10:00:00Z',
    createdAt: '2025-12-08T10:00:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-053',
    transactionNumber: 'TXN-2026-0053',
    type: 'transfer',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 80000,
    name: 'Bank Deposit',
    description: 'Weekly deposit to business account',
    transferToAccountId: 'acc-business',
    transferToAccountType: 'business',
    balanceBefore: 226250,
    balanceAfter: 146250,
    transactionDate: '2025-12-07T15:45:00Z',
    createdAt: '2025-12-07T15:45:00Z',
  },
  {
    id: 'txn-054',
    transactionNumber: 'TXN-2026-0054',
    type: 'expense',
    accountId: 'acc-hand',
    accountType: 'cash_in_hand',
    amount: 2600,
    ...
    balanceBefore: 92450,
    balanceAfter: 89850,
    transactionDate: '2025-12-06T14:00:00Z',
  ...
  },
  {
    ...
    accountType: 'business',
    amount: 55000,
    name: 'Networking Equipment Sales',
    description: 'Switches, routers and cables sold',
    category: 'Sales',
    balanceBefore: 704600,
    balanceAfter: 759600,
    transactionDate: '2025-12-05T12:30:00Z',
    createdAt: '2025-12-05T12:30:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-056',
    transactionNumber: 'TXN-2026-0056',
    type: 'expense',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 3200,
    name: 'Customer Appreciation Gifts',
    description: 'Year-end gifts for loyal customers',
    category: 'Other',
    balanceBefore: 146250,
    balanceAfter: 143050,
    transactionDate: '2025-12-04T11:00:00Z',
    createdAt: '2025-12-04T11:00:00Z',
    referenceType: 'other',
  },
  {
    id: 'txn-057',
    transactionNumber: 'TXN-2026-0057',
    type: 'income',
    accountId: 'acc-drawer',
    accountType: 'drawer',
    amount: 6800,
    name: 'Repair Service Income',
    description: 'Screen replacements and diagnostics',
    category: 'Repairs',
    balanceBefore: 143050,
    balanceAfter: 149850,
    transactionDate: '2025-12-03T15:20:00Z',
    createdAt: '2025-12-03T15:20:00Z',
    referenceType: 'invoice',
  },
  {
    id: 'txn-058',
    transactionNumber: 'TXN-2026-0058',
    type: 'expense',
    accountId: 'acc-business',
    accountType: 'business',
    amount: 9500,
    name: 'Annual Software Licenses',
    description: 'Microsoft and antivirus renewals',
    category: 'Supplies',
    balanceBefore: 759600,
    balanceAfter: 750100,
    transactionDate: '2025-12-02T10:15:00Z',
