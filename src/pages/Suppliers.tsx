    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-xl font-medium hover:opacity-90 transition-opacity shadow-lg shadow-violet-500/20"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className={`w-full max-w-md rounded-2xl border shadow-2xl overflow-hidden ${
              ...
              <div className="space-y-4">
                ...
                <div className={`p-4 rounded-xl border-l-4 ${
                  ...
                  <p className="text-sm font-medium">
                    Order form will open in your email client. Send your order details to the supplier via email.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`px-6 py-4 flex gap-3 ${theme === 'dark' ? 'bg-slate-800/30' : 'bg-slate-50'}`}>
              ...
              <button
                onClick={() => {
                  const subject = `Order from EchoTech - ${supplierForOrder.company}`;
                  const body = `Hi ${supplierForOrder.name},%0A%0AI would like to place an order.%0A%0APlease send me your product catalog and pricing.%0A%0ARegards`;
                  window.location.href = `mailto:${supplierForOrder.email}?subject=${subject}&body=${body}`;
